                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <div class="d-flex flex-column h-100">
                                <p class="fs-md text-muted mb-4">Total Order</p>
                        ...
                        <div class="flex-shrink-0">
                            <div id="property_sale" data-colors='["--tb-primary"]' dir="ltr">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <div class="d-flex flex-column h-100">
                                <p class="fs-md text-muted mb-4">Place Order</p>
                        ...
                        <div class="flex-shrink-0">
                            <div id="property_rent" data-colors='["--tb-warning"]' dir="ltr">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <div class="d-flex flex-column h-100">
                                <p class="fs-md text-muted mb-4">Reject Order</p>
                        ...
                        <div class="flex-shrink-0">
                            <div id="visitors_chart" data-colors='["--tb-secondary"]' dir="ltr">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <div class="d-flex flex-column h-100">
                                <p class="fs-md text-muted mb-4">Confirm Order</p>
        ...
        <div class="col-xxl-8">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title flex-grow-1 mb-0">Order Overview</h5>
                    <div class="flex-shrink-0">
